...
<body>
        ...
        <input type="button" onclick="window.location = 'member_history.php';" class="btn btn-primary" id="parking" value="Parking History"/>
            ...
            <form name="parkhis">
                    ...
                    <tr>
                        ...
                        <th class="col-md-5 col-xs-5">location</th>
                        <th class="col-md-5 col-xs-5">Start Parking</th>
                        <th class="col-md-5 col-xs-5">Stop Parking</th>
                    ...
                    <tbody>
                        ...
                        $ID=$_GET['print'];
                            ...
                            INNER JOIN car ON park.Car_ID = car.Car_ID 
                            where Park_ID=$key");
                            $show_park = mysqli_fetch_assoc($result_park);
                            ?>
                            <tr>
                            ...
                            <?php }
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        bootbox.alert({ 
                                          size: "small",
                                          message: "Plese select parking history",
                                          callback: function(){
                                            location.href="member_history.php";
                                          }
                                        })
                                    });
                                </script>
    ...
    <script type="text/javascript">
        ...
        function demoPDF() {
          ...
          var res = pdf.autoTableHtmlToJson(document.getElementById("park_table"));
          ...
          pdf.save("<?php echo date("Y-m-d H:i"); ?> parking record.pdf");
        };
