            ...
            <div class="col-md-8">
                <form name="carfrm" id="carform" method="post">
						<div class="container">
                            ...
                            <thead>
                                ...
                                <tbody>
				                <?php
									$result_car=mysqli_query($conn, "SELECT * FROM car where Driver_ID =  $sess_memid AND car_display = 'able'");
									$i = 1;
                ...
                <form name="editfrm" id="editform">
                    ...
                    <div class="control-group form-group" id="showedit" style="display:none;">
                        ...
                        <option value=""></option>
                        <?php
                        $car_query=mysqli_query($conn, "SELECT * FROM car where Driver_ID =  $sess_memid AND car_display = 'able'");
