...
<body>
    ...
    <div class="container" style="margin-bottom:70px;">
        ...
        <form method="get" action="print_reloadhis.php">
			<table class="table table-striped table-bordered" cellspacing="0" width="100%" id="reload_table">
                    ...
                    while($show_reload = mysqli_fetch_assoc($result_reload))
                    { 
                    ?>
                    <tr>
                        <td><input type="checkbox" name="print[]" id="print" value="<?php echo $show_reload["Topup_ID"] ?>"/></td>
