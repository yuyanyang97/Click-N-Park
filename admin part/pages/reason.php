                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php $summon_result = mysqli_query($conn,"SELECT * from summon_reason");
                                $i=1;
                                while($summon_rows = mysqli_fetch_assoc($summon_result))
                                    { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $i++ ?></td>
                                        <td><?php echo $summon_rows["reason_opt"] ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
							<br />
                            <form id="add_newreason">
							<button type="button" id="areabtn" class="btn btn-default">Add Reason</button>
							<div id="showNewArea" style="width:1000px;display:none;margin-top:5px;">
								<p>Enter a new reason: </p>
								<input type="text" class="form-control" width="200px" id="newreason" name="newreason" />
								<br />
