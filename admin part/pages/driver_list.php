...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Driver List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <form name="listfrm" method="post">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php $driver_result = mysqli_query($conn,"SELECT * from ((driver INNER JOIN states ON driver.Driver_state=states.state_id) INNER JOIN cities ON driver.Driver_city=cities.id) where driver.driver_display = 'able'");
                                $i=1;
                                while($driver_rows = mysqli_fetch_assoc($driver_result))
                                    { ?>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $i++ ?></td>
                                        <td><?php echo $driver_rows["Driver_Name"] ?></td>
										<td><?php echo $driver_rows["Driver_Address"] ?></td>
										<td><?php echo $driver_rows["name"] ?></td>
										<td><?php echo $driver_rows["city_name"] ?></td>
										<td><?php echo $driver_rows["Driver_Postcode"] ?></td>
                                        <td><?php echo $driver_rows["Driver_IC"] ?></td>
                                        <td><?php echo $driver_rows["Driver_Email"] ?></td>
                                        <td><?php echo $driver_rows["Driver_Mobile"] ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
    ...
    $("#delete").click(function(){
          ...
          $.ajax({
            url:"get_checked.php", //the page containing php script
