...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Officer List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $off_result = mysqli_query($conn,"SELECT * from officer");
                                $i=1;
                                while($off_rows = mysqli_fetch_assoc($off_result))
                                    { ?>
                                <tr class="odd gradeX">
                                    <td><?php echo $i++ ?></td>
                                    <td><?php echo $off_rows["Officer_Name"] ?></td>
                                    <td><?php echo $off_rows["Officer_No"] ?></td>
                                    <td><?php echo $off_rows["Officer_Mobile"] ?></td>
                                </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
