                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            $driver_query=mysqli_query($conn,"SELECT * FROM driver INNER JOIN topup ON driver.Driver_ID=topup.Driver_ID where driver.Driver_ID = '$ID'");
                            $driver_result=mysqli_fetch_assoc($driver_query);
                             ?>
                             Name: <?php echo $driver_result['Driver_Name']; ?>
                             <br />
                             Driver Balance: RM <?php echo $driver_result['Driver_Balance']; ?>
                             <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" method="post">
                                ...
                                <tbody>
                                <?php $topup_result = mysqli_query($conn,"SELECT * from topup INNER JOIN driver ON topup.Driver_ID=driver.Driver_ID where driver.Driver_ID= '$ID'");
                                $i=1;
