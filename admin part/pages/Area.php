...
<body>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                while($area_rows = mysqli_fetch_assoc($area_result))
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $i++ ?></td>
                                        <td><?php echo $area_rows["Area_Name"] ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
							<br />
                            <form id="add_newarea">
							<button type="button" id="areabtn" class="btn btn-default">Add Area</button>
							<div id="showNewArea" style="width:250px;display:none;margin-top:5px;">
								<p>Enter a new area: </p>
								<input type="text" class="form-control" width="200px" id="newarea" name="newarea" />
								<br />
    ...
    }, "Please Enter the correct area.");

        $("#add_newarea").validate({
