                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $car_result = mysqli_query($conn,"SELECT * from car INNER JOIN driver ON car.Driver_ID=driver.Driver_ID where car.car_display = 'able'");
                                $i=1;
                                while($car_rows = mysqli_fetch_assoc($car_result))
                                    { ?>
                                <tr class="odd gradeX">
                                    <td><?php echo $i++ ?></td>
                                    <td><?php echo $car_rows["Driver_Name"] ?></td>
                                    <td>
                                        <a href="car_view.php?car_id=<?php echo $car_rows["Car_ID"]?>">
                                            <?php echo $car_rows["Car_plat_No"] ?>     
                                        </a>
                                    </td>
                                </tr>
                                    <?php } ?>
