...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Driver Balance</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Name</th>
                                        <th>Balance Amount(RM)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php $driver_result = mysqli_query($conn,"SELECT * from driver where driver_display = 'able'");
                                $i=1;
                                while($driver_rows = mysqli_fetch_assoc($driver_result))
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $driver_rows["Driver_Balance"] ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
